    ...
    return (
        <div className={Styles.courses} id="courses">
            <div className="container">
                <h3 className={Styles.heading}>О курсах <br/> OGOGO Academy</h3>
                <p className={Styles.text}>Выбери одно из наших направлений <br/> и обучайся по удобной тебе системе</p>
                {
                    loading ?
                    ...
                    >
                        {
                            data.map(({image, title, short_description, full_description}, i) => {
                                return (
                                    <SwiperSlide className={Styles.slide} key={ i }>
                                        ...
                                        <div className={Styles.desc}>
                                            ...
                                            <button onClick={() => {showMore(i)}} className={Styles.button}>
                                                Подробнее
                                            </button>
                                        </div>
                                        <div className={`${Styles.full} ${show === i ? Styles.active : ''}`}>
                                            <h4>
                                                { title }
