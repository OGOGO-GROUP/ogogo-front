...
export const WhyUs = () => {
    ...
    const icons = importAll(require.context('./../../assets/images/whyus', false, /\.(png|jpe?g|svg)$/))
    ...
    return (
        <div className={Styles.whyus} id="whyus">
            <div className="container">
                <h3 className={Styles.heading}>Почему <br/> OGOGO Academy</h3>
                <div className={Styles.block}>
                    {
                        whyus.map(({icon, label}, i) => {
                            return (
                                <div data-aos="fade-up" data-aos-delay={i * 100} key={ i } className={Styles.item}>
